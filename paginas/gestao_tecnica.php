...
<body onload="inicializacao()">
	...
	<script type="text/javascript" src="js/VisaoTecnica.js"></script>
	<script type="text/javascript" src="js/ControleTecnica.js"></script>
	<script type="text/javascript" src="js/persistenciaTecnica.js"></script>
	<script type="text/javascript" src="js/event.js"></script>

<SCRIPT>
	var controle = new ControleTecnica();
...
<nav>
  <div class="nav-wrapper">
    <a href="admin.php" class="brand-logo">Gestão de Tecnicas de Pintura</a>
    <ul id="nav-mobile" class="right hide-on-med-and-down">
      <li><a class="waves-effect waves-teal btn-flat white-text" 
      onclick="location.href='cadastro_tecnica.php';"> Adicionar
